...
if __name__ == '__main__':
    ...
    trainDataList, trainLabelList = loadData('E://bd2019-weather-utilization-training-20190608.csv')

    # 获取测试集
    print('start read testSet')
    testDataList, testLabelList = loadData('E://bd2019-weather-utilization-training-20190608.csv')
